...
const Community = () => {
    ...
    const fetchCreations=async()=>{
        try {
            ...
            if(data.success){
                ...
                console.log("error frontend 1");
                toast.error(data.message);
            }
        } catch (error) {
            console.log("error frontend 2")
  ...
  return !loading?(
    ...
    <div className='flex justify-center items-center h-full'>
        <span className='w-10 h-10 my-1 rounded-full border-3 border-primary border-t-transparent anime-spin'></span>
    </div>
  )
}
